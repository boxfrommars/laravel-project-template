...
namespace {
    ...
    class Form extends \Rutorika\Html\FormFacade{
         ...
         * @static 
         */
        public static function audioUploadField($title, $name, $value = null, $options = array(), $help = ''){
            return \Rutorika\Html\FormBuilder::audioUploadField($title, $name, $value, $options, $help);
        }
